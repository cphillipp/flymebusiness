...
class RTThemePageLayoutOptions extends RTThemeAdmin{
	...
	function rt_generate_slider_box($theGroupID,$theTemplateID,$options,$randomClass){
			...
			$options = array (
					...
					array(
							"name"		=> __("Slider Nagation Items",'rt_theme_admin'), 
							"type" 		=> "heading"),
	...
	function rt_generate_product_box($theGroupID,$theTemplateID,$options,$randomClass){
			...
			$options = array (
					...
					array(
							...
							"desc" 	=> __("You can turn ON this option to activae ajax paginations. The pagination option above must be ON also to use this feature.",'rt_theme_admin'),
