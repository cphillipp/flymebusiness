...
$customFields = array(
			...
			array(
				   ...
				   "description" => __("You can select another google font for the heading just for this content. Make sure Google Fonts is ON inside the Typograpyh Options",'rt_theme_admin'),
			...
			array(
				   ...
				   "description" => __("You can select another google font for the text just for this content. Make sure Google Fonts is ON inside the Typograpyh Options",'rt_theme_admin'),
